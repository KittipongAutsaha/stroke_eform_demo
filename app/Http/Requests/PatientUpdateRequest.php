...
{
    /**
     * ตรวจสอบสิทธิ์ผู้ใช้ที่สามารถอัปเดตข้อมูลผู้ป่วยได้
     */
    public function authorize(): bool
    {
        // อนุญาตเฉพาะ admin / doctor / nurse เท่านั้น
        // ป้องกันไม่ให้ staff แก้ไขข้อมูลผู้ป่วย
        $user = $this->user();
    ...
    {
        // แปลง HN ให้เป็นตัวพิมพ์ใหญ่ และลบช่องว่าง
    ...
    public function rules(): array
    {
        ...
        return [
            // --- HN ---
            // Admin สามารถแก้ไขได้ แต่ต้องไม่ซ้ำและรูปแบบถูกต้อง
            // ผู้ใช้ทั่วไป (ไม่ใช่ admin) ห้ามส่ง HN เข้ามา
            'hn' => $isAdmin
                ? [
                    'bail',
                    'required',
