                ...
                <form
                    ...
                    <div>
                        ...
                        <textarea id="chief_complaint" name="chief_complaint" rows="3"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('chief_complaint', $note->chief_complaint) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="diagnosis" name="diagnosis" rows="3"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('diagnosis', $note->diagnosis) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="differential_diagnosis" name="differential_diagnosis" rows="2"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('differential_diagnosis', $note->differential_diagnosis) }}</textarea>
                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea id="clinical_summary" name="clinical_summary" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('clinical_summary', $note->clinical_summary) }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="physical_exam" name="physical_exam" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('physical_exam', $note->physical_exam) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea id="imaging_summary" name="imaging_summary" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('imaging_summary', $note->imaging_summary) }}</textarea>
                        </div>
                        <div class="flex items-center gap-3 mt-6 sm:mt-0">
                            <input type="hidden" name="lvo_suspected" value="0">
                    ...
                    <div class="grid sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea id="treatment_plan" name="treatment_plan" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('treatment_plan', $note->treatment_plan) }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="orders" name="orders" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('orders', $note->orders) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="prescription_note" name="prescription_note" rows="3"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('prescription_note', $note->prescription_note) }}</textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-4">
                        ...
                        <div class="flex gap-2">
                            @php
                                // ถ้าปิดเคสแล้วให้ซ่อนปุ่มบันทึก
                                $canSubmit = !($mode === 'edit' && $isLocked);
                            @endphp
